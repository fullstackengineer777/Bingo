          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post" action="{{ route('user.register') }}">
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Please, enter your first vname!</div>
                    </div>
                    <div class="col-12">
             ...
             <!--        <div class="col-12">
                    ...
                    <div class="col-12">
                      <label for="yourPassword_con" class="form-label">Password Confirmation</label>
                      <input type="password" name="password_confirmation" class="form-control" id="yourPassword_con" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="{{ route('user.login.page') }}">Log in</a></p>
                    </div>
                  </form>
